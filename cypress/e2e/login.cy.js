...
describe('Login spec', () => {
  beforeEach(() => {
    // Untuk bisa menguji halaman login, Cypress perlu mengakses halaman tersebut. Gunakan perintah cy.visit() dan beri argumen dengan nilai http://localhost:3000/untuk mengunjungi halaman login.
